      ...
      <section className="flex items-center justify-center min-h-screen bg-gray-100">
        <div className="flex items-center max-w-3xl p-5 bg-gradient-to-r from-indigo-600 to-purple-600 rounded-2xl">
          <div className="px-8 md:w-1/2">
            ...
            <p className="mt-4 text-sm text-white">If you already a member, easily log in now.</p>
            ...
            <div className="items-center mt-6 text-white">
                  ...
                  C36.971,39.205,44,34,44,24C44,22.659,43.862,21.35,43.611,20.083z"
					...
					<div className="flex items-center justify-between mt-4 text-sm text-white">
						...
						<button className="hover:border register bg-[#002D74] hover:border-gray-400 rounded-xl py-2 px-5 hover:scale-110 hover:bg-[#002c7424] font-semibold duration-300"  onClick={() => navigate("/register")}>Register</button>
					</div>
				</div>

				<div className="hidden w-1/2 md:block">
					<img className="rounded-2xl max-h-[1800px] " src="https://cdni.iconscout.com/illustration/premium/thumb/user-login-illustration-download-in-svg-png-gif-file-formats--password-profile-businessman-pack-business-illustrations-5857593.png?f=webp" alt="login form" />
				</div>
			</div>
		</section>
    );
