   ...
   <section className="flex items-center justify-center min-h-screen bg-gray-100">
           <div className="flex items-center max-w-3xl p-5 bg-gradient-to-r from-indigo-600 to-purple-600 rounded-2xl">
             <div className="px-8 md:w-1/2">
               ...
               <p className="mt-4 text-sm text-white">You are not a member yet, register now.</p>
               ...
               <div className="items-center mt-6 text-white">
                    ...
                    <div className="py-5 mt-10 text-sm text-white border-b border-gray-500 playfair tooltip">Forget password?</div>
   
                    <div className="flex items-center justify-between mt-4 text-sm text-white">
                        <p className="mr-3 md:mr-0">If you have an account..</p>
                        <button className="hover:border register bg-[#002D74] hover:border-gray-400 rounded-xl py-2 px-5 hover:scale-110 hover:bg-[#002c7424] font-semibold duration-300"  onClick={() => navigate("/login")}>Login</button>
                    </div>
                </div>
   
                <div className="hidden w-1/2 md:block">
                    <img className="rounded-2xl max-h-[1600px]" src="https://cdni.iconscout.com/illustration/premium/thumb/training-specialist-providing-to-customers-on-product-usage-and-features-illustration-download-in-svg-png-gif-file-formats--customer-support-pack-services-illustrations-7342869.png" alt="login form" />
                </div>
            </div>
        </section>
  )
